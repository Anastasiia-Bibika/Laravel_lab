...
<form action="{{route('calls.store')}}" method="post" class="border-2 object-center border-indigo-500/100 divide-y divide-blue-200" >
    ...
    @csrf
    <label for="number_call" class="mx-5 py-5">Number_call</label>
    <input required name="number_call" class="outline outline-2  outline-offset-2"/>
    <br/>
    <label for="duration" class="mx-5 py-5">Duration</label>
    <input required name="duration" class="outline outline-2  outline-offset-2"/>
    <br/>
    <label for="pay" class="mx-5 py-5">Pay</label>
    <input required name="pay" class="outline outline-2  outline-offset-2"/>
    <br/>
    <label for="implementation_time" class="mx-5 py-5">Implementation time</label>
